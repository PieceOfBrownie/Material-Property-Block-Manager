...
{
    MaterialPropertyBlockManager materialPropertyBlockManager;
    ...
    void OnEnable()
    {
        materialPropertyBlockManager = (MaterialPropertyBlockManager)target;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (materialPropertyBlockManager.gameObject.GetComponent<MeshRenderer>().sharedMaterials.Length > 1)
        {
            EditorGUILayout.LabelField("Materials", EditorStyles.boldLabel);
            EditorGUILayout.IntSlider(materialIndex,
                                      0, materialPropertyBlockManager.gameObject.GetComponent<MeshRenderer>().sharedMaterials.Length - 1,
        ...
        Material material = materialPropertyBlockManager.gameObject.GetComponent<MeshRenderer>().sharedMaterials[0];
        ...
        if (EditorGUI.EndChangeCheck())
        {
            ...
            materialPropertyBlockManager.UpdateMaterial();
        }
    }
